 ...
 */
data class Event// This method is private - to create a new event, use one of the create* utility methods.
(private val mEventType: Int // The type of event - one of the constants above
 ...
 val mX: Int, val mY: Int, // If this is of type EVENT_TYPE_SUGGESTION_PICKED, this must not be null (and must be null in
        // other cases).
 val mSuggestedWordInfo: SuggestedWordInfo?, // Some flags that can't go into the key code. It's a bit field of FLAG_*
 ...
 val mNextEvent: Event?) {
    ...
    init {
        ...
        if (EVENT_TYPE_SUGGESTION_PICKED == mEventType) {
            if (null == mSuggestedWordInfo) {
                throw RuntimeException("Wrong event: SUGGESTION_PICKED event must have a " + "non-null SuggestedWordInfo")
            }
        } else {
            if (null != mSuggestedWordInfo) {
                throw RuntimeException("Wrong event: only SUGGESTION_PICKED events may have " + "a non-null SuggestedWordInfo")
            }
        }
    }
    ...
    companion object {
        ...
        // through combination.
        val EVENT_TYPE_INPUT_KEYPRESS = 1
        ...
        fun createEventForCodePointFromUnknownSource(codePoint: Int): Event {
            ...
            return Event(EVENT_TYPE_INPUT_KEYPRESS, null, codePoint, NOT_A_KEY_CODE,
                    Constants.NOT_A_COORDINATE, Constants.NOT_A_COORDINATE, null, FLAG_NONE, null/* next */)/* text *//* suggestedWordInfo */
        }
        ...
        fun createEventForCodePointFromAlreadyTypedText(codePoint: Int,
            ...
            // TODO: should we have a different type of event for this? After all, it's not a key press.
            return Event(EVENT_TYPE_INPUT_KEYPRESS, null, codePoint, NOT_A_KEY_CODE,
                    x, y, null, FLAG_NONE, null/* next */)/* text *//* suggestedWordInfo */
        }
        ...
        fun createSuggestionPickedEvent(suggestedWordInfo: SuggestedWordInfo): Event {
            return Event(EVENT_TYPE_SUGGESTION_PICKED, suggestedWordInfo.word,
        ...
        fun createSoftwareTextEvent(text: CharSequence, keyCode: Int): Event {
            return Event(EVENT_TYPE_SOFTWARE_GENERATED_STRING, text, NOT_A_CODE_POINT, keyCode,
                    Constants.NOT_A_COORDINATE, Constants.NOT_A_COORDINATE, null, FLAG_NONE, null/* next */)/* suggestedWordInfo */
        }
        ...
        fun createPunctuationSuggestionPickedEvent(
            ...
            val primaryCode = suggestedWordInfo.word[0].toInt()
            return Event(EVENT_TYPE_SUGGESTION_PICKED, suggestedWordInfo.word, primaryCode,
                    NOT_A_KEY_CODE, Constants.SUGGESTION_STRIP_COORDINATE,
                    Constants.SUGGESTION_STRIP_COORDINATE, suggestedWordInfo, FLAG_NONE, null/* next */)
        }
