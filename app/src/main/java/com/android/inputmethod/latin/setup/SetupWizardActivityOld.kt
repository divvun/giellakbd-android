...
class SetupWizardActivityOld : Activity(), View.OnClickListener {
    ...
    private class SettingsPoolingHandler(ownerInstance: SetupWizardActivityOld,
                                         private val mImmInHandler: InputMethodManager) : LeakGuardHandlerWrapper<SetupWizardActivityOld>(ownerInstance) {
    ...
    internal fun invokeSetupWizardOfThisIme() {
        val intent = Intent()
        intent.setClass(this, SetupWizardActivityOld::class.java)
    ...
    internal class SetupStep(val mStepNo: Int, applicationName: String, private val mBulletView: TextView,
        ...
        init {
            ...
            if (actionIcon == 0) {
                val paddingEnd = mActionLabel.paddingEnd
    ...
    companion object {
        internal val TAG = SetupWizardActivityOld::class.java.simpleName
