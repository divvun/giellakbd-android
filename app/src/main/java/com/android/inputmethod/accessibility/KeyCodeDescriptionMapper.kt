...
internal class KeyCodeDescriptionMapper private constructor() {
    ...
    fun getDescriptionForKey(context: Context, keyboard: Keyboard,
        ...
        if (code != Constants.CODE_UNSPECIFIED) {
            ...
            val isDefinedNonCtrl = Character.isDefined(code) && !Character.isISOControl(code)
    ...
    companion object {
        ...
        private val SPOKEN_LETTER_RESOURCE_NAME_FORMAT = "spoken_accented_letter_%04X"
        private val SPOKEN_SYMBOL_RESOURCE_NAME_FORMAT = "spoken_symbol_%04X"
        private val SPOKEN_EMOJI_RESOURCE_NAME_FORMAT = "spoken_emoji_%04X"
        private val SPOKEN_EMOTICON_RESOURCE_NAME_PREFIX = "spoken_emoticon"
        private val SPOKEN_EMOTICON_CODE_POINT_FORMAT = "_%02X"
        ...
        private fun getDescriptionForSwitchAlphaSymbol(context: Context,
            ...
            when (elementId) {
                ...
                KeyboardId.ELEMENT_ALPHABET_MANUAL_SHIFTED, KeyboardId.ELEMENT_ALPHABET_SHIFT_LOCK_SHIFTED,
